                ...
                foreach ($careers as $career): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="./Controllers/GetById.php?action=edit&id=<?php echo $career['id_career']; ?>" class="btn btn-primary btn-sm mr-2">Editar</a>
                            <a href="./Controllers/GetById.php?action=delete&id=<?php echo $career['id_career']; ?>" class="btn btn-danger btn-sm">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
